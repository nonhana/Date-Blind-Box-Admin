...
const target = "http://www.nonhana.site:4040/"; // 目标网址
 ...
 * 然后拼接 http://www.nonhana.site:4040/
 * 如：ajax.post("/api/getlist") => http://www.nonhana.site:4040/api/react-ant-admin/getlist
 */
